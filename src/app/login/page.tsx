...
const DEMO_CREDENTIALS = [
  { username: "admin", password: "ccrd2026", displayName: "Admin User" },
];
...
function BlueprintGrid() {
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      <div className="absolute inset-0" style={{ background: "radial-gradient(ellipse at 50% 40%, rgba(14,45,82,0.9) 0%, #080f1a 70%)" }} />
      <div className="absolute inset-0" style={{ opacity: 0.12 }}>
        <div className="absolute" style={{ inset: "-120px", backgroundImage: "linear-gradient(rgba(56,189,248,0.5) 1px, transparent 1px), linear-gradient(90deg, rgba(56,189,248,0.5) 1px, transparent 1px)", backgroundSize: "60px 60px", animation: "ccrd-grid-scroll 8s linear infinite" }} />
      </div>
      <div className="absolute inset-0" style={{ opacity: 0.04 }}>
        <div className="absolute" style={{ inset: "-60px", backgroundImage: "linear-gradient(rgba(125,211,252,0.6) 1px, transparent 1px), linear-gradient(90deg, rgba(125,211,252,0.6) 1px, transparent 1px)", backgroundSize: "15px 15px", animation: "ccrd-grid-scroll 12s linear infinite" }} />
      </div>
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full" style={{ background: "radial-gradient(circle, rgba(0,120,199,0.15) 0%, transparent 65%)", animation: "ccrd-float 10s ease-in-out infinite" }} />
      <div className="absolute left-0 right-0 h-[1px] pointer-events-none" style={{ background: "linear-gradient(90deg, transparent, rgba(56,189,248,0.25), transparent)", animation: "ccrd-scan 6s linear infinite" }} />
    </div>
  );
}
...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center" style={{ backgroundColor: "#080f1a" }}>
      ...
      <div className="absolute hidden lg:block" style={{ top: "18%", left: "10%", animation: "ccrd-drift-1 20s ease-in-out infinite, ccrd-fade-up 1s ease-out 0.8s both" }}>
      ...
      <div className="absolute hidden lg:block" style={{ top: "20%", right: "8%", animation: "ccrd-drift-2 24s ease-in-out infinite, ccrd-fade-up 1s ease-out 1s both" }}>
        <div className="font-mono text-[10px] rounded-lg px-3 py-2 border" style={badgeBase}>
          <div className="flex items-center gap-1.5 mb-1">
      ...
      <div className="absolute hidden lg:block" style={{ bottom: "20%", left: "6%", animation: "ccrd-drift-3 22s ease-in-out infinite, ccrd-fade-up 1s ease-out 1.2s both" }}>
        <div className="font-mono text-[10px] rounded-lg px-3 py-2 border" style={badgeBase}>
          <div className="flex items-center gap-1.5 mb-1">
      ...
      <div className="absolute hidden lg:block" style={{ bottom: "16%", right: "10%", animation: "ccrd-drift-4 18s ease-in-out infinite, ccrd-fade-up 1s ease-out 1.4s both" }}>
        <div className="font-mono text-[10px] rounded-lg px-3 py-2 border" style={badgeBase}>
          <div className="flex items-center gap-1.5 mb-1">
      ...
      <div className="relative w-full max-w-sm mx-6 z-10">
        ...
        <div className="flex flex-col items-center mb-6" style={{ animation: "ccrd-fade-up 0.6s ease-out both" }}>
          <div className="relative">
            <div className="absolute inset-0 rounded-2xl blur-2xl" style={{ background: "radial-gradient(circle, rgba(56,189,248,0.3) 0%, rgba(0,120,199,0.2) 40%, transparent 70%)", transform: "scale(3)", animation: "ccrd-float 4s ease-in-out infinite" }} />
            <div className="absolute inset-0 rounded-2xl blur-md" style={{ background: "radial-gradient(circle, rgba(125,211,252,0.35) 0%, rgba(56,189,248,0.12) 50%, transparent 70%)", transform: "scale(2)" }} />
            <div className="relative w-14 h-14 rounded-2xl flex items-center justify-center border border-white/15" style={{ backgroundColor: "rgba(0,120,199,0.3)", backdropFilter: "blur(8px)" }}>
          ...
          <form onSubmit={handleLogin} className="space-y-3.5">
            <div>
              ...
              <input
                ...
                style={{ backgroundColor: "rgba(8,15,26,0.6)", border: "1px solid rgba(56,189,248,0.12)" }}
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 text-white font-medium text-sm rounded-lg px-4 py-2.5 transition-all disabled:opacity-60 disabled:cursor-not-allowed"
              style={{
